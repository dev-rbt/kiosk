<template>
    <svg :width="width" :height="height" viewBox="0 -4 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_503_4206)">
            <rect width="28" height="20" rx="2" fill="white" />
            <mask id="mask0_503_4206" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="28"
                height="20">
                <rect width="28" height="20" rx="2" fill="white" />
            </mask>
