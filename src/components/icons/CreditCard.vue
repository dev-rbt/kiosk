<template>
    <svg :width="width" :height="height" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path opacity="0.5" d="M10 16.5H6" :stroke="fill" stroke-width="1.5" stroke-linecap="round" />
        <path opacity="0.5" d="M8 13.5H6" :stroke="fill" stroke-width="1.5" stroke-linecap="round" />
        <path opacity="0.5" d="M2 10L22 10" :stroke="fill" stroke-width="1.5" stroke-linecap="round" />
        <path opacity="0.5"
